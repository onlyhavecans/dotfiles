function fix_vmware --description "Clean up after broken AF vagrant-vmware plugin"
  ...
  sudo sed  -i .bak '/^add_nat_portfwd 8 tcp [0-9]* [0-9.]* 22 $/d' /Library/Preferences/VMware\ fusion/networking

  status_message "Clean up incoming mappings in nat.conf"
  # 2201 = 192.168.107.170:22
  sudo sed -i .bak '/^22[0-9][0-9] = [0-9.]*:22$/d' /Library/Preferences/VMware\ fusion/vmnet8/nat.conf
