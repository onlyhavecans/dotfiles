...
# It parses an input string for a [date string] at the beginning 
...
#
# Example usage:
# logtodayone.rb "This is a entry."
# logtodayone.rb "[yesterday 3pm] Something I did yesterday at 3:00PM"
# logtodayone.rb "[-2 1:30am] An entry about something I did two days ago"
...
%x{/usr/local/bin/dayone2 --date="#{date}" new "#{input}"}
